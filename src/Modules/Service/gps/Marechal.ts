...
@Injectable()
export class MarechalService {
  private readonly logger = new Logger(MarechalService.name);
  ...
  async fetchAndSaveData() {
    const gpsConfig = this.configService.get('gps.marechal');
