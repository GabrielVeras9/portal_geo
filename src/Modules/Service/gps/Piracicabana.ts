...
@Injectable()
export class PiracicabanaService {
  private readonly logger = new Logger(PiracicabanaService.name);
  ...
  async fetchAndSaveData() {
    const gpsConfig = this.configService.get('gps.piracicabana');
